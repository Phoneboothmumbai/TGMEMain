...
export const PhilosophySection = () => {
  return (
    <section id="philosophy" className="py-24 lg:py-32 bg-slate-950 relative overflow-hidden">
      {/* Background Elements */}
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            <div className="pl-8">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
                ...
                <br />
                <span className="text-amber-400">Principles don't.</span>
              </h2>
              ...
              <div className="bg-slate-800/30 border border-slate-700/50 rounded-xl p-6 backdrop-blur-sm">
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  ...
                  <span className="text-amber-400 font-medium"> make technology dependable again.</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            {philosophyPoints.map((point, idx) => (
              <div
                key={point.id}
                className="flex gap-6 p-6 bg-slate-800/20 border border-slate-700/30 rounded-xl transition-all duration-300 hover:bg-slate-800/40 hover:border-amber-500/20 group"
              >
                <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-amber-500/10 flex items-center justify-center text-amber-400 font-bold text-lg group-hover:bg-amber-500/20 transition-colors">
