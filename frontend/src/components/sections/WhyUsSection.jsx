...
export const WhyUsSection = () => {
  return (
    <section id="why-us" className="py-24 lg:py-32 bg-slate-950 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-slate-800/30 rounded-full blur-3xl" />
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
              ...
              <span className="text-slate-500"> We focus on </span>
              <span className="text-amber-400">what actually works.</span>
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {differentiators.map((item, idx) => {
              ...
              return (
                <Card
                  key={item.id}
                  className={`bg-slate-800/30 border-slate-700/50 backdrop-blur-sm transition-all duration-300 hover:bg-slate-800/50 hover:border-amber-500/20 hover:-translate-y-1 group ${
                    idx === 0 ? 'sm:col-span-2' : ''
                  }`}
                >
                  <CardContent className="p-6">
                    <div className="w-12 h-12 rounded-lg bg-slate-700/50 flex items-center justify-center mb-4 group-hover:bg-amber-500/20 transition-colors">
